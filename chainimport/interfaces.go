...
// state. Requires Reset() to initialize before using Next/NextBatch methods.
type StatefulIterator interface {
	...
	// Reset initializes the iterator for stateful iteration with
	// Next/NextBatch.
	Reset(start, end uint32)
